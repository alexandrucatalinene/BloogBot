        ...
        public static float GetGearScoreWithItem(Item item)
        {
            ...
            switch (item.InventoryType)
            {
                ...
                case (int)InventoryType.Holdable:
                    if (characterEquip.MainHandItem.ItemClass != ItemClassV2.AxeTwoHand
                        && characterEquip.MainHandItem.ItemClass != ItemClassV2.MaceTwoHand
                        && characterEquip.MainHandItem.ItemClass != ItemClassV2.SwordTwoHand
                        && characterEquip.MainHandItem.ItemClass != ItemClassV2.Polearm
                        && characterEquip.MainHandItem.ItemClass != ItemClassV2.Spear
                        && characterEquip.MainHandItem.ItemClass != ItemClassV2.Staff)
                    {
